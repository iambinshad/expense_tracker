...
import 'package:expense_tracker/presentation/pages/home/widgets/insights.dart';
...
class BottomNav extends StatelessWidget {
    ...
    return ChangeNotifierProvider(
      ...
      child: Consumer<BottomNavProvider>(
        builder: (context, value, child) => Scaffold(
          ...
          floatingActionButton:!value.isBottomNavHide? FloatingActionButton(
            onPressed: () => _showAddExpenseSheet(context),
            child: const Icon(Icons.add_rounded),
          ):SizedBox(),
          bottomNavigationBar: !value.isBottomNavHide? BottomNavigationBar(
  ...
  void _showAddExpenseSheet(BuildContext context) {
    ...
    PageRouteBuilder(
      pageBuilder: (context, animation, secondaryAnimation) => const AddExpenseSheet(),
